...
urlpatterns = [
    ...
    path('edit-training/<int:training_id>/', views.edit_training, name='edit_training'),  # Add this line
    ...
    path('reset-my-password/', views.reset_own_password, name='reset_own_password'),
    ...
    path('delete-nomination/<int:nomination_id>/', views.delete_nomination, name='delete_nomination'),  # ADD THIS LINE
